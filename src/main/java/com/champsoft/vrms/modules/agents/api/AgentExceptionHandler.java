package com.champsoft.vrms.modules.agents.api;

import com.champsoft.vrms.modules.agents.application.exception.*;
import com.champsoft.vrms.modules.agents.domain.exception.*;
    ...
    private String toReadableMessage(org.springframework.http.converter.HttpMessageNotReadableException ex) {
        ...
        while (current != null) {
            if (current instanceof com.fasterxml.jackson.databind.exc.InvalidFormatException ife) {
                if (ife.getTargetType() == com.champsoft.vrms.modules.agents.domain.model.Role.class) {
